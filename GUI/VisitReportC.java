...
public class VisitReportC implements Initializable{
	...
	/**
	 *  This function prepare the visit report before loading the report 
	 *  THE function takes the data from the DB via the report controller 
	 *  it also prepare chart that present the number of each type of visitors were in range of hours in the park
	 *  and it prepare chart that present number of each type of visitors that stay x time in the park  
	 */
