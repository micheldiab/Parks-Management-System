...
public class DepManagerControllerGUI implements Initializable {
	...
	/**
	 * this function loading the match GUI after clicking on View More Button 
	 * if the selected row is sale , the function load department sale GUI
	 * if the selected row is parameter , the function load department parameters GUI
	 * @param event
	 * @throws Exception
	 */
	@FXML
	...
	/**
	 * this function prepare the tableview that hold all the request in all the parks 
	 */
	@Override
	public void initialize(URL location, ResourceBundle resources) {
		...
		welcomeLabel.setText("Welcome, " + GoNatureClient.currentWorker.getFirstName() + " " + GoNatureClient.currentWorker.getLastName());
		...
		SaleRequestsLabel.setText("You Have\r\n" + SaleRequestInTreatment + "\r\n" + "Sale requests \r\n in treatment\r\n" + "");
	...
	/** 
	 * this function takes all the parameters and sale's request of specific park from the DB via the ReportsController 
	 * it takes the park name from the combobox 
	...
	/**
	 * this function remove the effect of more info button when the cursor is not on the button 
	 * @param event
	 */
	@FXML
	...
	/**
	* this function set a effect in more info button when the cursor is on the button 
	 * @param event
	 */
	@FXML
